    ...
    return (
        <div>
            ...
            <div className="xl:px-20 px-8 py-20 2xl:mx-auto 2xl:container relative z-40">
                <CarouselProvider infinite={true} isPlaying={true} naturalSlideWidth={100} naturalSlideHeight={100} isIntrinsicHeight={true} totalSlides={2} interval={1000} playDirection="forward" >
